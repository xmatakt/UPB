...
{
    class TripleDesAlgorithmClass : BaseCryptographyClass
    {
        ...
        public TripleDesAlgorithmClass(string password, int keyLength)
        ...
        /// </summary>
        /// <param name="password">Heslo na zaklade ktoreho je vygenerovany kluc.</param>
        public TripleDesAlgorithmClass(string password)
            : base(password)
        {
